(function () {
    'use strict';
    var controllerId = 'cotacao.notificacao.fornecedor';

    function cotacaoNotificacaoFornecedor(autenticacao, $rootScope, services, $state, load, $ionicHistory) {
        var vm = this;
        vm.mensagens = [];
    ...
    angular.module('cotarApp').controller(controllerId, ['autenticacao', '$rootScope', 'services', '$state', 'load', '$ionicHistory', cotacaoNotificacaoFornecedor]);
})();