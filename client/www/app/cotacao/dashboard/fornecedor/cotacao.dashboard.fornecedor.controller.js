(function () {
    'use strict';
    var controllerId = 'cotacao.dashboard.fornecedor';

    function cotacaoDashboardFornecedor(socket, services, autenticacao, load, $state, $cordovaBadge) {
        socket.connect();
        var vm = this;
        var categoria = {};
        vm.solicitacoes = [];
    ...
    angular.module('cotarApp').controller(controllerId, ['socket', 'services', 'autenticacao', 'load', '$state', '$cordovaBadge', cotacaoDashboardFornecedor]);
