(function () {
    'use strict';
    var controllerId = 'compra.fornecedor';

    angular.module('cotarApp').controller(controllerId, ['$timeout', 'connection', '$scope', '$ionicPopup', '$ionicModal',
        'autenticacao', '$rootScope', '$location', 'services', '$state', 'load', '$ionicHistory', compraFornecedor]);

    function compraFornecedor($timeout, connection, $scope, $ionicPopup, $ionicModal, autenticacao,
